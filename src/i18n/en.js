export const en = {
  ...
  whyWorkWithUs: {
    title: "Why Work With GST Solutions?",
    subtitle:
    ...
    contact: "Contact Us Discuss Your Technology Need",
    features: {
      datadriven: {
  ...
  header: {
    companyName: "Global Standard Technology",
    slogan: "The Future of Innovation",
    buyBarcode: "Buy Barcode",
    login: "Login",
    email: "info@gstsa1.org",
  ...
  proServices: {
    ...
    noData: "No professional services available at the moment.",
    more: "Learn More",
    supplies: {
  ...
  coreSolutions: {
    ...
    subtitle:
      "Comprehensive barcode and tracking solutions designed to streamline your operations and ensure Global standards compliance.",
    noData: "No core solutions available at the moment.",
    learnMore: "Learn More",
  },
  partners: {
    our: "Our",
