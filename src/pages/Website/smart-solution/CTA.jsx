...
function CTA() {
  return (
    <div className="relative bg-gradient-to-br from-secondary via-tertiary to-primary py-16 px-4 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight font-dubai">
              Verify list of products, premises and abattoirs from{" "}
              <span className="text-green-300">
                85 Halal Certification Bodies
              </span>{" "}
              in <span className="text-green-400">47 countries!</span>
            </h2>

            {/* App Description */}
            <div className="mb-8">
              <h3 className="text-xl font-bold text-white mb-4 font-dubai">
                Verify Halal Mobile Application
              </h3>
              <p className="text-white/90 leading-relaxed text-sm md:text-base">
                Verify Halal™ is a smartphone application endorsed by JAKIM that
                is developed to empower consumers and retailers with the ability
                to instantly verify the Halal accreditation of a product by a
                simple scan of a barcode or QR Code via their smartphone
                cameras. It's latest feature includes Location-based service
                which allow users to pin and tag the location of Halal goods for
                easy viewing by other consumers that are looking for the same
                products within the 20km radius. Verify Halal™ features JAKIM
                and JAKIM's recognised International Halal Certification Bodies,
                Products, Brands, Premises and Abattoir.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="w-80 h-96 bg-gray-200 rounded-3xl shadow-2xl flex items-center justify-center border-8 border-gray-800 relative overflow-hidden">
                ...
                <div className="text-center p-8 mt-8">
                  ...
                  <h4 className="text-primary font-bold mb-2">Verify Halal</h4>
                  <p className="text-gray-600 text-sm">Mobile Application</p>
              ...
              {/* Replace this div with actual image later */}
              {/* <img src="/path/to/mobile-app-screenshot.png" alt="Verify Halal Mobile App" className="w-80 h-96 object-cover rounded-3xl shadow-2xl" /> */}
            </div>
          </div>
        </div>
      </div>
