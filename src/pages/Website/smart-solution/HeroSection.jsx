...
function HeroSection() {
  return (
    <div className="relative bg-gradient-to-br from-primary via-navy-600 to-navy-700 min-h-[70vh] flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto">
        <h1 className="text-white text-4xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight font-dubai">
          ...
          <br />
          Halal Products and Services Today
        </h1>

        <p className="text-white/80 text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
          Your trusted platform for authentic halal products and services
          worldwide
        </p>
        ...
        <div className="relative max-w-2xl mx-auto">
          <div className="flex flex-col sm:flex-row gap-0 bg-white/95 backdrop-blur-lg rounded-2xl p-2 shadow-2xl border border-white/20">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search for Halal products or premises..."
