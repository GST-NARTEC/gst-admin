...
import { useUpdateCompanyMutation } from "../../../../store/apis/endpoints/compnies";
import { useGetPagesQuery } from "../../../../store/apis/endpoints/pageSetup";

function EditCompanyModal({ isOpen, onOpenChange, company }) {
  ...
  useEffect(() => {
    if (company) {
      setFormData({
        icon: null, // Always null for new uploads
      ...
      // Set preview image from existing company icon
      if (company.icon) {
        setPreviewIcon(company.icon);
      } else {
        setPreviewIcon(null);
      }
    }
  ...
  const resetForm = () => {
    if (company) {
      ...
      // Reset preview image from existing company icon
      if (company.icon) {
        setPreviewIcon(company.icon);
      } else {
        setPreviewIcon(null);
