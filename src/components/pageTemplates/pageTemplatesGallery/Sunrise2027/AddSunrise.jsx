...
function AddSunrise() {
  ...
  useEffect(() => {
    if (isError) {
      ...
      toast.success("Sunrise 2027 template created successfully");
      navigate(-1);
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error("Failed to create Sunrise 2027 template:", err);
    }
  };
  return (
    <MainLayout>
      <div className="p-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold">Add New Sunrise 2027</h1>
        </div>
          ...
          <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                ...
                isLoading={isLoading}
              >
                {isLoading ? "Creating..." : "Create Sunrise 2027"}
              </Button>
            </div>
          </div>
        </div>
