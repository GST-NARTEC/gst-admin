    ...
    return (
      <section className="py-24 relative overflow-hidden">
        <div className="flex justify-center items-center min-h-[400px]">
          <p className="text-gray-500 text-lg">{t("coreSolutions.noData")}</p>
        </div>
      </section>
    );
  }
      ...
      <div className="mx-16 px-4 relative">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-primary via-tertiary to-quaternary bg-clip-text text-transparent">
            {t("coreSolutions.title")}
          </h2>
          <p className="max-w-3xl mx-auto text-gray-600 text-lg">
            {t("coreSolutions.subtitle")}
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="relative p-6 bg-white">
                ...
                <p className="text-gray-600 mb-4 line-clamp-2">
                  {isArabic ? solution.descriptionAr : solution.descriptionEn}
                </p>
                ...
                <div className="flex items-center justify-between">
                  <button className="flex items-center gap-2 text-quaternary font-semibold group/btn">
                    <span className="relative">
                      {isArabic
                        ? solution.captionAr
                        : solution.captionEn || t("coreSolutions.learnMore")}
