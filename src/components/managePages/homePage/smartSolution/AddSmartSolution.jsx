...
import { useCreateSmartSolutionMutation } from "../../../../store/apis/endpoints/websiteEndpoints/smartSolution";
import { useGetPagesQuery } from "../../../../store/apis/endpoints/pageSetup";

function AddSmartSolution({ isOpen, onOpenChange }) {
  const [createSmartSolution, { isLoading }] = useCreateSmartSolutionMutation();
  ...
  const handleSubmit = async () => {
    try {
      ...
      await createSmartSolution(formDataToSubmit).unwrap();
      toast.success("Smart Solution added successfully");
      onOpenChange(false);
      ...
      toast.error(error.data?.message || "Failed to add smart solution");
    }
  };
...
export default AddSmartSolution;
